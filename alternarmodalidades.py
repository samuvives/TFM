# this is for doing the ablation study. 
# the thing is to be able to
# have the views in a list
# delete the view and save it as a variable
# run the model with the rest of the variables putting without{discardedview} 

# mejor version: usando un generador

import os

discardeview = views.pop(0)
...
modalidades = modalidades[1:] + [modalidades[0]]
